...
public class MainActivity extends AppCompatActivity {
    ...
    public void insert()
    {
        try
        {
            ...
            db.execSQL("CREATE TABLE IF NOT EXISTS records(id INTEGER PRIMARY KEY AUTOINCREMENT,name VARCHAR,location VARCHAR,length VARCHAR,level VARCHAR, discription VARCHAR )");
            String sql = "insert into records(name,location,length,level,discription)values(?,?,?,?,?)";
